...
def get_parser():
    ...
    parser.add_argument('--save_dir', type=str, default='./exp/debug', help='./pretrained directory for all savings')
    ...
    parser.add_argument('--batch_size', type=int, default=4096, help='batch_size') # 256
    ...
    parser.add_argument('--epoch_num', type=int, default=50001, help='epoch_num')   # 20001
    ...
    parser.add_argument('--normalization', type=int, default=1) # 1
    ...
    parser.add_argument('--lambda_rec', type=float, default=5)  # 5
    parser.add_argument('--lambda_cycle', type=float, default=5)
    parser.add_argument('--lambda_ee', type=float, default=100)
    parser.add_argument('--lambda_global_pose', type=float, default=1.5)    # 2.5
...
def get_std_bvh(args=None, dataset=None):
    ...
    std_bvh = './datasets/CMP/std_bvhs/{}.bvh'.format(dataset)
    return std_bvh
