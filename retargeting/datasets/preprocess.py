...
sys.path.append(new_working_dir)
...
def copy_std_bvh(data_path, character, files):
    ...
    cmd = 'cp \"{}\" ./datasets/G1_less/std_bvhs/{}.bvh'.format(data_path + character + '/' + files[0], character)
    os.system(cmd)


if __name__ == '__main__':
    prefix = './datasets/G1_less/'     #'./datasets/Mixamo/'
    ...
    for character in characters:
        ...
        write_statistics(character, './datasets/G1_less/mean_var/')
