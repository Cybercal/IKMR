...
class Poselib_g1:
    ...
    def get_bvh_header(self, skt):
        ...
        # local_translation = [np.array([t[0], t[2], -t[1]]) for t in local_translation]
            ...
            local_translation[0][1] = 0
            local_translation[0][2] = 0.9037
    ...
    def get_bvh_channels(self, skm):
        # 提取所有帧的旋转和位置数据
        local_rotation = skm.local_rotation[:5].numpy()  # size(frames, joints, 4), q = [x, y, z, w]
        root_translation = skm.root_translation[:5].numpy()
